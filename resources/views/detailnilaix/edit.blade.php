	...
	<div class="row">
			...
			<div class="card border-dark">
				...
				<div class="card-body">
					<div class="form-group">
						<div>
							<h4 class="card-title">Edit Data {{ $detailnilaix->nilaix->kodenilai }}</h4>
						</div>
						<div class="form-row">
					...
					<p class="card-text">
						{!! Form::model($detailnilaix, [
								'route' => ['detailnilai.update', $detailnilaix->id],
								'method' => 'PUT',
								'name' => 'autoSumForm',
							])
						!!}
		...
		<div class="col-md-4">
			<div class="card border-dark">
				...
				<div class="form-row">
						<div class="form-group col-md-6">
							{!! Html::linkroute('detailnilai.show', 'Batal', [$detailnilaix->id], [
